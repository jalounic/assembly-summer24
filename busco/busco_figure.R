...
# Output
my_output <- paste("summaries/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('canu-polished', 'canu-polished', 'canu-polished', 'canu-polished', 'canu-raw', 'canu-raw', 'canu-raw', 'canu-raw', 'flye-polished', 'flye-polished', 'flye-polished', 'flye-polished', 'flye-raw', 'flye-raw', 'flye-raw', 'flye-raw', 'trinity', 'trinity', 'trinity', 'trinity')
...
my_percentage <- c(97.5, 1.6, 0.0, 0.9, 95.1, 2.0, 1.4, 1.5, 97.8, 1.6, 0.0, 0.6, 97.6, 1.6, 0.2, 0.6, 21.6, 48.6, 4.8, 25.0)
my_values <- c(4479, 75, 2, 40, 4372, 92, 64, 68, 4495, 72, 1, 28, 4484, 72, 9, 31, 991, 2232, 220, 1153)
